...
2. Se a pergunta não estiver no contexto, diga "Não tenho conhecimento sobre esse tipo de informação."
...
2. Se a resposta não estiver no CONTEXTO, diga "Não tenho essa informação."
3. Não invente informações.
4. Use markdown para formatar a resposta.
5. Sempre inclua links quando disponíveis.
`;
